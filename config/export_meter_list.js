...
async function export_data(req,res){
    try {
        let name_file = "BAO_CAO_DANH_SACH_TRAM_QUAN_TRAC"
        ...
        worksheet.getCell('A2').value = "BÁO CÁO DANH SÁCH TRẠM QUAN TRẮC";
        ...
        worksheet.getCell('A5').fill = {
          ...
          worksheet.getCell('B5').value = "Mã trạm";
          ...
          worksheet.getCell('D5').value = "Trạng thái";
          ...
          worksheet.getCell('E5').value = "Mã thiết bị";
          ...
          worksheet.getCell('F5').value = "Tần suất thu thập (Phút)";
          ...
          worksheet.getCell('G5').value = "Vị trí Lat";
          ...
          worksheet.getCell('H5').value = "Vị trí Long";
          ...
          worksheet.getCell('J5').value = "Đồng bộ DLSTNMT";
          worksheet.getCell('J5').font ={name: 'Arial', size: 10, bold: true };
          ...
          worksheet.getCell('K5').value = "Hệ số xung";
          worksheet.getCell('K5').font ={name: 'Arial', size: 10, bold: true };
          ...
          worksheet.getCell('L5').value = "Chỉ số chốt cài đặt";
          worksheet.getCell('L5').font ={name: 'Arial', size: 10, bold: true };
          ...
          worksheet.getCell('M5').value = "Seri sim";
          worksheet.getCell('M5').font ={name: 'Arial', size: 10, bold: true };
          ...
          for(let i=0; i<result.length; i++){
            ...
            worksheet.getCell('B'+(6+i)).value =  result[i].ma_tram;
            worksheet.getCell('B'+(6+i)).alignment = { vertical: 'middle', horizontal: 'center', wrapText : true };

            worksheet.getCell('C'+(6+i)).value =  result[i].meter_name;
            worksheet.getCell('C'+(6+i)).alignment = { vertical: 'middle', horizontal: 'center', wrapText : true };

            // worksheet.getCell('D'+(6+i)).value =  show_if_null_text(result[i].ten_donvi);
            // worksheet.getCell('D'+(6+i)).alignment = { vertical: 'middle', horizontal: 'center', wrapText : true };

            worksheet.getCell('D'+(6+i)).value =  return_meter_status(result[i].status);
            worksheet.getCell('D'+(6+i)).alignment = { vertical: 'middle', horizontal: 'center', wrapText : true };

            worksheet.getCell('E'+(6+i)).value =  data[i].MeterCode
            worksheet.getCell('E'+(6+i)).alignment = { vertical: 'middle', horizontal: 'center', wrapText : true };
    
            worksheet.getCell('F'+(6+i)).value =  show_if_null_text(result[i].frequency);
            worksheet.getCell('G'+(6+i)).value =  show_if_null_text(result[i].location_lat);
            worksheet.getCell('H'+(6+i)).value =  show_if_null_text(result[i].location_long);
            worksheet.getCell('I'+(6+i)).value =  show_if_null_text(result[i].address);
            worksheet.getCell('J'+(6+i)).value =  (result[i].sync_tnmt_data == 1) ? "Bật" : "Tắt";
            worksheet.getCell('K'+(6+i)).value =  show_if_null_text(result[i].multiplier);
            worksheet.getCell('L'+(6+i)).value =  show_if_null_text(result[i].first_index);
            worksheet.getCell('M'+(6+i)).value =  show_if_null_text(result[i].serial_sim);
